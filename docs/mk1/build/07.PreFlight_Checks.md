---
page_title: Engravinator Mk1 &mdash; Build &mdash; Pre-Flight Checks
photogallery: true
home_url: /mk1/build/
prev_url: 06.Controller.html
prev_text: Controller
next_url: 08.Enclosure.html
next_text: Enclosure
---
# Pre-Flight Checks
...
<div class="callout alert"><b><i class="material-icons">warning</i> But first, for safety, disconnect the laser cable from the top of the laser module. Just in case you do something silly that might turn the laser on ;)</b></div>
...
<div class="callout alert"><b><i class="material-icons">warning</i>THIS IS EXTREMELY IMPORTANT</div>
...
- <span class="dot green"></span> M3x20 bolt (x4)
